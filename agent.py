...
class SacAgent:
    ...
    def __init__(self, env, log_dir, num_episodes=5000, batch_size=256,
    ...
    def run(self):
        for i in range(self.num_episodes):
            ...
            if i+1 % 50 == 0 or i == self.num_episodes-1 or stop_training:
                plt.clf()
                plt.plot([x+1 for x in range(len(self.train_rewards))], self.train_rewards)
